...
public class PlayerMotor : EntityBehaviour<IPlayerState>
{
    ...
    /// <summary>
    /// Set the camera active only if this entity is the owner
    /// </summary>
    ...
    /// <returns>It returns the stateMotor which is used in PlayerController to synchronize the pos and rot</returns>
    ...
    /// <summary>
    /// Controls the Jumping Mechanism
    /// </summary>
